...
describe("revString", function () {
  xit("returns a reversed copy of the string", function () {
...
describe("gatherStrings", function () {
  xit("gathers all object string values into an array", function () {
    let whiskey = {
      name: "Whiskey",
      age: 5,
      favFood: "popcorn",
  ...
  xit("handles nested objects", function () {
    let nestedObj = {
      firstName: "Lester",
      favoriteNumber: 22,
      moreData: {
